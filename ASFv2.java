...
if(args.length <1) {
System.err.println("Please specifiy document root directory");
System.exit(1);
}
...
InputStreamEntity body = new InputStreamEntity(instream, 1024);
BufferedHttpEntity body2 = new BufferedHttpEntity(body);
